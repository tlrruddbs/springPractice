...
public class ProxyFactoryConfigV2 {
    ...
    public OrderControllerV2 orderControllerV2(LogTrace logTrace){
        ...
        log.info("ProxyFacyory proxy={}, target={}", proxy.getClass(), orderControllerV2.getClass());
    ...
    public OrderServiceV2 orderServiceV2(LogTrace logTrace){
        ...
        log.info("ProxyFacyory proxy={}, target={}", proxy.getClass(), orderServiceV2.getClass());
    ...
    public OrderRepositoryV2 orderRepositoryV2(LogTrace logTrace){
        ...
        log.info("PorxyFactory proxy={}, target={}",proxy.getClass(), orderRepository.getClass());
